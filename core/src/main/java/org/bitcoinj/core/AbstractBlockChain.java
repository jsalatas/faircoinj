...
public abstract class AbstractBlockChain {
    ...
    public AbstractBlockChain(Context context, List<? extends Wallet> wallets,
        ...
        this.txFeeChangeListeners = new CopyOnWriteArrayList<ListenerRegistration<TransactionFeeChangedListener>>();
    ...
    public void addListener(BlockChainListener listener, Executor executor) {
        ...
        addTransactionFeeChangedListener(executor, listener);
    }
    ...
    public void removeListener(BlockChainListener listener) {
        ...
        removeTransactionFeeChangedListener(listener);
    }
