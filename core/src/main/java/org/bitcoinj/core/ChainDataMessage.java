 ...
 */
//TODO: still only a plain copy of AddressMessage
public class ChainDataMessage extends Message {
     ...
     */
    ChainDataMessage(NetworkParameters params, byte[] payload, int offset, MessageSerializer setSerializer, int length) throws ProtocolException {
     ...
     * @throws ProtocolException
     */
    ChainDataMessage(NetworkParameters params, byte[] payload, MessageSerializer serializer, int length) throws ProtocolException {
        super(params, payload, 0, serializer, length);
    }

    ChainDataMessage(NetworkParameters params, byte[] payload, int offset) throws ProtocolException {
        super(params, payload, offset, params.getDefaultSerializer(), UNKNOWN_LENGTH);
    }

    ChainDataMessage(NetworkParameters params, byte[] payload) throws ProtocolException {
