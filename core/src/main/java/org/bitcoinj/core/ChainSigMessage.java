...
public class ChainSigMessage extends Message {
     ...
     */
    ChainSigMessage(NetworkParameters params, byte[] payload, int offset, MessageSerializer setSerializer, int length) throws ProtocolException {
     ...
     * @throws ProtocolException
     */
    ChainSigMessage(NetworkParameters params, byte[] payload, MessageSerializer serializer, int length) throws ProtocolException {
        super(params, payload, 0, serializer, length);
    }

    ChainSigMessage(NetworkParameters params, byte[] payload, int offset) throws ProtocolException {
        super(params, payload, offset, params.getDefaultSerializer(), UNKNOWN_LENGTH);
    }

    ChainSigMessage(NetworkParameters params, byte[] payload) throws ProtocolException {
