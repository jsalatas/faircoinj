...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/faircoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/faircoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/faircoin-paymentack";
