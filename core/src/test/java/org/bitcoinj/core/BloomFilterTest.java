...
public class BloomFilterTest {
    ...
    public void walletTest() throws Exception {
        DumpedPrivateKey privKey = DumpedPrivateKey.fromBase58(MAINNET, "8Ueh1r3runfgMBaMf4rZZXR8XjQXLPaRQYbGjZa2NDTsHUqFXec");

        Address addr = LegacyAddress.fromKey(MAINNET, privKey.getKey());

        assertTrue(addr.toString().equals("fZCHNpVFtkUcxnzu5uPLpUcjpD6D5pu4AM"));
        ...
        // Value generated by Bitcoin Core
        assertTrue(Arrays.equals(HEX.decode("08a8ed20896d1d0a6e080000000000000002"), filter.unsafeBitcoinSerialize()));
    }
}
