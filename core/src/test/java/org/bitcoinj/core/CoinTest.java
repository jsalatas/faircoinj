...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 FAIR", COIN.toFriendlyString());
        assertEquals("1.23 FAIR", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 FAIR", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 FAIR", valueOf(1, 23).negate().toFriendlyString());
    }
