...
public class ECKeyTest {
    ...
    public void verifyMessage() throws Exception {
        ...
        Address expectedAddress = Address.fromBase58(MainNetParams.get(), "fHegygi5YWTmUfD7i2XFNMmfqkPic6uq48");
