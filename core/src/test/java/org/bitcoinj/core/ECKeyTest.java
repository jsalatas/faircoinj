...
public class ECKeyTest {
    ...
    public void verifyMessage() throws Exception {
        ...
        Address expectedAddress = LegacyAddress.fromBase58(MAINNET, "fHegygi5YWTmUfD7i2XFNMmfqkPic6uq48");
