...
public class BtcFormatTest {
    ...
    public void repeatingPlaceTest() {
        ...
        assertEquals("53.29999999999999", mega.format(value, 0, BtcFixedFormat.REPEATING_PLACES));
        assertEquals("53.29999999999999", mega.format(value, 0, BtcFixedFormat.REPEATING_PLACES));
        assertEquals("53.29999999999999", mega.format(value, 1, BtcFixedFormat.REPEATING_PLACES));
        assertEquals("53.29999999999999", mega.format(value, 2, BtcFixedFormat.REPEATING_PLACES));
        assertEquals("53.29999999999999", mega.format(value, 3, BtcFixedFormat.REPEATING_PLACES));
        assertEquals("53.29999999999999", mega.format(value, 0, BtcFixedFormat.REPEATING_DOUBLETS));
        assertEquals("53.29999999999999", mega.format(value, 1, BtcFixedFormat.REPEATING_DOUBLETS));
        assertEquals("53.29999999999999", mega.format(value, 2, BtcFixedFormat.REPEATING_DOUBLETS));
        assertEquals("53.29999999999999", mega.format(value, 3, BtcFixedFormat.REPEATING_DOUBLETS));
        assertEquals("53.29999999999999", mega.format(value, 0, BtcFixedFormat.REPEATING_TRIPLETS));
        assertEquals("53.29999999999999", mega.format(value, 1, BtcFixedFormat.REPEATING_TRIPLETS));
        assertEquals("53.29999999999999", mega.format(value, 2, BtcFixedFormat.REPEATING_TRIPLETS));
        assertEquals("53.29999999999999", mega.format(value, 3, BtcFixedFormat.REPEATING_TRIPLETS));
    ...
    public void btcRounding() throws Exception {
        ...
        assertEquals("53.30", megaFormat.format(MAX_MONEY));
